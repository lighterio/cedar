...
module.exports = function createLogger(options) {
  ...
  var jsonSpace, breakIndent;

  // TODO: Make logger.jsonSpace non-enumerable.
  logger.setJsonSpace = function setJsonSpace(value) {
    jsonSpace = logger.jsonSpace = value;
    breakIndent = '\n' + value;
  };
  ...
  logger.stringifyArguments = function stringifyArguments(args) {
    ...
    // Hide stderr in case we stringify deprecated properties.
